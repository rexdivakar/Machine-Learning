...
test["Key Topic.Author"]=final_status[:,1]


#Test system

test.to_csv('/home/divakar/Desktop/testfinal.csv',columns=['Book-id','Key Topic'])

with open('/home/divakar/Desktop/testfinal.csv') as csvfile:
